...
public abstract class DLPythonAbstractCommands implements DLPythonCommands {
    ...
    public void trainNetwork(final DLPythonNetworkHandle network, final DLNetworkInputProvider trainingInputProvider,
        ...
        final OldPythonKernelBackend kernelBackend = getLegacyKernelBackend(kernel);
    ...
    @SuppressWarnings("resource") // Kernel and back end are closed when the surrounding instance is closed.
    private static OldPythonKernelBackend getLegacyKernelBackend(final PythonKernel kernel)
